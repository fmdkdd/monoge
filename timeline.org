...
This is not the proper way to fix out however, because forcing an adapter for
...
** Plugging the metamodel extension language                       :emfviews:
...
* [2017-11-15 mer.]
** Further work on MEL grammar/syntax                              :emfviews:
...
* [2017-11-20 lun.]
** Fixing the filter property bug                                  :emfviews:
...
** About the duplication in the ATL transformation             :emfviews:atl:
...
** Further MEL improvements                                        :emfviews:
- Multiple inheritance
...
* [2017-11-21 mar.]
** Handle modify property clause in ATL transformation             :emfviews:
