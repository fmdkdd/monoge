 ...
 * @generated
 */
public class VirtuallinksneoemfPackageImpl extends EPackageImpl implements VirtuallinksneoemfPackage {
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   ...
   * @see virtuallinksneoemf.VirtuallinksneoemfPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private VirtuallinksneoemfPackageImpl() {
    super(eNS_URI, VirtuallinksneoemfFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link VirtuallinksneoemfPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static VirtuallinksneoemfPackage init() {
    if (isInited) return (VirtuallinksneoemfPackage)EPackage.Registry.INSTANCE.getEPackage(VirtuallinksneoemfPackage.eNS_URI);

    // Obtain or create and register package
    VirtuallinksneoemfPackageImpl theVirtuallinksneoemfPackage = (VirtuallinksneoemfPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof VirtuallinksneoemfPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new VirtuallinksneoemfPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theVirtuallinksneoemfPackage.createPackageContents();

    // Initialize created meta-data
    theVirtuallinksneoemfPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theVirtuallinksneoemfPackage.freeze();


    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(VirtuallinksneoemfPackage.eNS_URI, theVirtuallinksneoemfPackage);
    return theVirtuallinksneoemfPackage;
  }
   ...
   */
  @Override
  public VirtuallinksneoemfFactory getVirtuallinksneoemfFactory() {
    return (VirtuallinksneoemfFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents() {
    ...
    initEReference(getWeavingModel_VirtualConcepts(), this.getVirtualConcept(), null, "virtualConcepts", null, 0, -1, WeavingModel.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getWeavingModel_VirtualProperties(), this.getVirtualProperty(), null, "virtualProperties", null, 0, -1, WeavingModel.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getWeavingModel_VirtualAssociations(), this.getVirtualAssociation(), null, "virtualAssociations", null, 0, -1, WeavingModel.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getWeavingModel_Filters(), this.getFilter(), null, "filters", null, 0, -1, WeavingModel.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEClass(virtualConceptEClass, VirtualConcept.class, "VirtualConcept", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getVirtualConcept_SuperConcepts(), this.getConcept(), null, "superConcepts", null, 0, -1, VirtualConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getVirtualConcept_SubConcepts(), this.getConcept(), null, "subConcepts", null, 0, -1, VirtualConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getVirtualProperty_Parent(), this.getConcept(), null, "parent", null, 1, 1, VirtualProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getVirtualProperty_Type(), ecorePackage.getEString(), "type", null, 1, 1, VirtualProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getVirtualProperty_Optional(), ecorePackage.getEBoolean(), "optional", null, 0, 1, VirtualProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(virtualAssociationEClass, VirtualAssociation.class, "VirtualAssociation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getVirtualAssociation_Source(), this.getConcept(), null, "source", null, 1, 1, VirtualAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getVirtualAssociation_Target(), this.getConcept(), null, "target", null, 1, 1, VirtualAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getVirtualAssociation_LowerBound(), ecorePackage.getEInt(), "lowerBound", null, 1, 1, VirtualAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
    initEAttribute(getVirtualAssociation_UpperBound(), ecorePackage.getEInt(), "upperBound", null, 1, 1, VirtualAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
    initEReference(getVirtualAssociation_Opposite(), this.getAssociation(), null, "opposite", null, 0, 1, VirtualAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
    initEAttribute(getVirtualAssociation_Composition(), ecorePackage.getEBoolean(), "composition", null, 0, 1, VirtualAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(filterEClass, Filter.class, "Filter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFilter_Target(), this.getConcreteElement(), null, "target", null, 1, 1, Filter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(concreteConceptEClass, ConcreteConcept.class, "ConcreteConcept", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(concreteAssociationEClass, ConcreteAssociation.class, "ConcreteAssociation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
