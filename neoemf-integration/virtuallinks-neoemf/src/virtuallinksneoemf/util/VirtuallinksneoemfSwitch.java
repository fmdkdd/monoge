 ...
 * @generated
 */
public class VirtuallinksneoemfSwitch<T> extends Switch<T> {
  /**
   ...
   * @generated
   */
  public VirtuallinksneoemfSwitch() {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case VirtuallinksneoemfPackage.WEAVING_MODEL: {
        WeavingModel weavingModel = (WeavingModel)theEObject;
        T result = caseWeavingModel(weavingModel);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.VIRTUAL_LINK: {
        VirtualLink virtualLink = (VirtualLink)theEObject;
        T result = caseVirtualLink(virtualLink);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.VIRTUAL_CONCEPT: {
        VirtualConcept virtualConcept = (VirtualConcept)theEObject;
        T result = caseVirtualConcept(virtualConcept);
        if (result == null) result = caseVirtualLink(virtualConcept);
        if (result == null) result = caseVirtualElement(virtualConcept);
        if (result == null) result = caseConcept(virtualConcept);
        if (result == null) result = caseElement(virtualConcept);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.VIRTUAL_PROPERTY: {
        VirtualProperty virtualProperty = (VirtualProperty)theEObject;
        T result = caseVirtualProperty(virtualProperty);
        if (result == null) result = caseVirtualLink(virtualProperty);
        if (result == null) result = caseVirtualElement(virtualProperty);
        if (result == null) result = caseElement(virtualProperty);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.VIRTUAL_ASSOCIATION: {
        VirtualAssociation virtualAssociation = (VirtualAssociation)theEObject;
        T result = caseVirtualAssociation(virtualAssociation);
        if (result == null) result = caseVirtualLink(virtualAssociation);
        if (result == null) result = caseVirtualElement(virtualAssociation);
        if (result == null) result = caseAssociation(virtualAssociation);
        if (result == null) result = caseElement(virtualAssociation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.FILTER: {
        Filter filter = (Filter)theEObject;
        T result = caseFilter(filter);
        if (result == null) result = caseVirtualLink(filter);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.CONTRIBUTING_MODEL: {
        ContributingModel contributingModel = (ContributingModel)theEObject;
        T result = caseContributingModel(contributingModel);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.CONCRETE_ELEMENT: {
        ConcreteElement concreteElement = (ConcreteElement)theEObject;
        T result = caseConcreteElement(concreteElement);
        if (result == null) result = caseElement(concreteElement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.CONCEPT: {
      ...
      case VirtuallinksneoemfPackage.ASSOCIATION: {
      ...
      case VirtuallinksneoemfPackage.CONCRETE_CONCEPT: {
        ConcreteConcept concreteConcept = (ConcreteConcept)theEObject;
        T result = caseConcreteConcept(concreteConcept);
        if (result == null) result = caseConcreteElement(concreteConcept);
        if (result == null) result = caseConcept(concreteConcept);
        if (result == null) result = caseElement(concreteConcept);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.CONCRETE_ASSOCIATION: {
        ...
        if (result == null) result = caseConcreteElement(concreteAssociation);
        if (result == null) result = caseAssociation(concreteAssociation);
        if (result == null) result = caseElement(concreteAssociation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.ELEMENT: {
        Element element = (Element)theEObject;
        T result = caseElement(element);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VirtuallinksneoemfPackage.VIRTUAL_ELEMENT: {
        VirtualElement virtualElement = (VirtualElement)theEObject;
        T result = caseVirtualElement(virtualElement);
        if (result == null) result = caseElement(virtualElement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Virtual Concept</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Virtual Association</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Concrete Concept</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
