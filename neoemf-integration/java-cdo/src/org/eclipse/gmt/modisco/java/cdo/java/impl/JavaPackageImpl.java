...
public class JavaPackageImpl extends EPackageImpl implements JavaPackage {
	 ...
	 * @see org.eclipse.gmt.modisco.java.cdo.java.JavaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("org.eclipse.gmt.modisco.java.cdo.java." + eClassifier.getName());
