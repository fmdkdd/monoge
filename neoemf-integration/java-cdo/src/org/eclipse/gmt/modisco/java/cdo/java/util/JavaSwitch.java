...
public class JavaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case JavaPackage.PACKAGE: {
				org.eclipse.gmt.modisco.java.cdo.java.Package package_ = (org.eclipse.gmt.modisco.java.cdo.java.Package)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(org.eclipse.gmt.modisco.java.cdo.java.Package object) {
		return null;
	}
