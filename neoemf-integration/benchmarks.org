...
|------+-----+----------+---------+-------------+------------------|
|    1 |   1 |     1658 |      26 |         164 |              571 |
|    2 |   2 |      690 |     209 |         120 |             1421 |
|    3 |   8 |      489 |     705 |         387 |              860 |
|    4 |   4 |      786 |   14094 |        1101 |             2915 |
|    5 |  35 |     4114 | 1359528 |        4601 |            20605 |
|    6 | 175 |    33011 |       n |       60041 |           457920 |
#+TBLFM: @2$2..@>$2=remote(xmi-load, @@#$3)+remote(xmi-load, @@#$4)
#+TBLFM: @2$3..@>$3=remote(xmi-view-load, @@#$3)+remote(xmi-view-load, @@#$4)
#+TBLFM: @2$4..@>$4=remote(neoemf-load-direct-write,@@#$4)
#+TBLFM: @2$5..@>$5=remote(neoemf-load-long-list,@@#$3)+remote(neoemf-load-long-list,@@#$4)
#+TBLFM: @2$6..@>$6=remote(neoemf-view-load-long-list,@@#$3)+remote(neoemf-view-load-long-list,@@#$4)
...
** TODO Aggregate results and graphs
